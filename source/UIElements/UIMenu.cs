...
namespace SteelCustom.UIElements
{
    public class UIMenu : ScriptComponent
    {
        ...
        private UIButton CreateMenuButton(string text, float y)
        {
            ...
            button.RectTransform.AnchoredPosition = new Vector2(2 * K, y);
        ...
        private UIButton CreateSoundButton()
        {
            ...
            button.RectTransform.Pivot = new Vector2(1, 0.5f);
            button.RectTransform.Size = new Vector2(39 * K, 13 * K);
            button.RectTransform.AnchoredPosition = new Vector2(-2 * K, 30 * K);
        ...
        {
            UIText text = UI.CreateUIText("Created in 48 hours for LD53 using Steel Engine", "About", menu);
